...
# Rotation config
test_config = {}
test_config['do_rotate'] = True
test_config['skew_labels'] = False
test_config['skew_rotations'] = True
test_config['rotations'] = np.array(range(72)) * 5
test_config['rotation_probs'] = np.zeros(72)
test_config['rotation_probs'][:24] = 1/100
test_config['rotation_probs'][24:48] = 10/100
test_config['rotation_probs'][48:] = 89/100


train_config = {}
train_config['do_rotate'] = True
train_config['skew_labels'] = False
train_config['skew_rotations'] = True
train_config['rotations'] = np.array(range(36)) * 10
train_config['rotation_probs'] = np.zeros(36)
train_config['rotation_probs'][:12] = 1/100
train_config['rotation_probs'][12:24] = 10/100
train_config['rotation_probs'][24:] = 89/100
...
class StaticMNIST(Dataset):
    ...
    def __init__(self, data, split,
        ...
        self.class_with_ids = self._get_class_ids(self.labels)
    ...
    def _get_class_ids(self, labels):
        ...
        for cls in range(self.n_classes):
            ids = np.nonzero(np.asarray(self.labels == cls))[0]
